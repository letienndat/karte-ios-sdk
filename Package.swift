...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "KarteInAppMessaging", url: "https://raw.githubusercontent.com/letienndat/xcframework/main/KarteInAppMessaging.xcframework.zip", checksum: "435d9b6ee6203a5c287a28f32a3bce043ee274471d96bfdc0778a0daa981cf5a"
        ),
        .binaryTarget(
